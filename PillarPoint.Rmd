...
```{r, Loading Packages (without renv)}
#If you're not able to use "renv", you can also install the appropriate packages manually with this code:
...
#make combined PDF of Part I, Part II, Part III, Part IV
#for combined PDF, find every page number where names occur
#compare page numbers to 
