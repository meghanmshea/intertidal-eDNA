...
![*Supplemental Figure X: Heat map of identified indicator ASVs for all three locations over time, scaled by the number of replicates that detected that species.*](`r paste0(path, "png")`)
