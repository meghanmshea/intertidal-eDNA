...
overlap_table
write.csv(overlap_table, "Data/Analysis Products/TableS1.csv", row.names=TRUE)
```

By analyzing occurrence data from the Global Biodiversity Information Facility (on `r Sys.Date()` `Sys.Date()`), we confirmed that `r percentages$count[6]` `r percentages$count[6]` of `r sum(percentages$count)``sum(percentages$count)` identified species (`r sprintf("%0.1f%%", percentages$count[6] * 100)` `sprintf("%0.1f%%", percentages$count[6] * 100)`) have occurrence records at Pillar Point, specifically. An additional `r percentages$count[5]` `r percentages$count[5]` identified species (`r sprintf("%0.1f%%", percentages$count[5] * 100)` `sprintf("%0.1f%%", percentages$count[5] * 100)`) have occurrence records in the California Current System (CCS) and known ranges that encompass Pillar Point. Of the remaining species, some only fulfilled one of two criteria; `r percentages$count[4]` `r percentages$count[4]` identified species (`r sprintf("%0.1f%%", percentages$count[4] * 100)` `sprintf("%0.1f%%", percentages$count[4] * 100)`) had occurrence records in the CCS but known ranges that did not encompass Pillar Point and `r percentages$count[3]` `r percentages$count[3]` identified species (`r sprintf("%0.1f%%", percentages$count[3] * 100)` `sprintf("%0.1f%%", percentages$count[3] * 100)`) had ranges that encompass Pillar Point but no occurrence records in the CCS. Additionally, `r percentages$count[1]` `r percentages$count[1]` identified species (`r sprintf("%0.1f%%", percentages$count[1] * 100)` `sprintf("%0.1f%%", percentages$count[1] * 100)`) had neither occurrence records in the CCS nor known ranges that encompassed Pillar Point. Finally, `r percentages$count[2]` `r percentages$count[2]` identified species (`r sprintf("%0.1f%%", percentages$count[2] * 100)` `sprintf("%0.1f%%", percentages$count[2] * 100)`) lacked sufficient occurrence records in GBIF to make any designation, and `r percentages$count[7]` `r percentages$count[7]` identified species (`r sprintf("%0.1f%%", percentages$count[7] * 100)` `sprintf("%0.1f%%", percentages$count[7] * 100)`) did not have species-level records in GBIF. Full details by species can be found in Table S2.
...
write.csv(GBIF_summary, "Data/Analysis Products/TableS2.csv", row.names=TRUE)
```
