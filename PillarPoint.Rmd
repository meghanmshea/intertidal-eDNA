...
condense_no_pages$Zone_1 = !sapply(condense_no_pages$Zone_4, is.null)
condense_no_pages$Zone_2 = !sapply(condense_no_pages$Zone_3, is.null)
condense_no_pages$Zone_3 = !sapply(condense_no_pages$Zone_2, is.null)
condense_no_pages$Zone_4 = !sapply(condense_no_pages$Zone_1, is.null)

condense_no_pages = condense_no_pages %>% arrange(name)
condense_no_pages = condense_no_pages %>% arrange(desc(Zone_4)) %>% arrange(desc(Zone_3)) %>% arrange(desc(Zone_2)) %>% arrange(desc(Zone_1))
condense_no_pages = condense_no_pages %>% arrange(Site)
